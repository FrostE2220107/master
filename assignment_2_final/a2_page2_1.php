...
<option value = "a2_page2_2.php">Meal Type</option>
			...
			<input type="text" class="form-control" id="searchBox" placeholder="Search by main ingredient"> 
		  </div>
		</form>	
		<p id="results"></p>
	</div>
...
<script>
	...
	function doSearch() {
		...
		fetch('https://mi-linux.wlv.ac.uk/~2220107/Y2/assignment_2/a2_search_1.php?search=' + keywords)
