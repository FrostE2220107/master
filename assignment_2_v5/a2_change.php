...
//insert to database
$sql = "UPDATE website_dishes SET Dish = '$dish', Main_ingredient = '$ingr_1', Ingredient2 = '$ingr_2', Ingredient3 = '$ingr_3', Meal_type = '$mty', Main_flavour = '$manfl', Prep_time = '$prepti', Serves = '$serve', WHERE id = '$number' ";
