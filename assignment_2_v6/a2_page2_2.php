    ...
    <div class="container">
		...
		<form class="row g-3">
		  <div class="col-auto">
			...
			<input type="text" class="form-control" id="searchBox" placeholder="Search by Meal Type"> 
		  </div>
		</form>	
		<p id="results"></p>
	</div>
...
<script>
	...
	function doSearch() {
		...
		fetch('https://mi-linux.wlv.ac.uk/~2220107/Y2/assignment_2/a2_search.php?search#2=' + keywords)
